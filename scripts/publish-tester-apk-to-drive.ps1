# Copy the Arrs Hub Mobile Tester APK into Google Drive\apks (and local apks/).
# Keeps the current versioned file plus ArrsHubMobileTester-latest.apk alias.
# Does NOT touch ArrsHubStatus-*.apk production artifacts.
#
# Usage:
#   .\scripts\publish-tester-apk-to-drive.ps1
#   .\scripts\publish-tester-apk-to-drive.ps1 -Build   # assembleDebug first
...
Write-Host "Drive apks (Tester): $(Join-Path $DriveApks $destName)"
